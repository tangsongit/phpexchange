...
class Option extends Bar
{
    ...
    public function handle(Request $request)
    {
        ...
        $builder1 =
            ...
            $builder12 =
            $builder13 =
            OptionSceneOrder::query()->whereIn('user_id', $base_ids)->where(['bet_coin_id' => $coin_id]);
...
<div class="d-flex p-1 flex-column justify-content-between" style="padding-top: 0;width: 100%;height: 100%;min-height: {$minHeight}">
    ...
    <a href="{$admin_url}/option/option-order?agent_id={$referrer}" class="btn btn-primary shadow waves-effect waves-light">View Details <i class="feather icon-chevrons-right"></i></a>
</div>
HTML
        );
    }
