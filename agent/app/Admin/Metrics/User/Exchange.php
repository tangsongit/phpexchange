...
class Exchange extends Bar
{
    ...
    public function handle(Request $request)
    {
        ...
        $builder2 = InsideTradeOrder::query()
            ->where('buy_user_id', $user_id)
            ->orWhere('sell_user_id', $user_id)
...
<div class="d-flex p-1 flex-column justify-content-between" style="padding-top: 0;width: 100%;height: 100%;min-height: {$minHeight}">
    ...
    <a href="{$admin_url}/exchange/trade-order?user_id={$user_id}" class="btn btn-primary shadow waves-effect waves-light">View Details <i class="feather icon-chevrons-right"></i></a>
</div>
HTML
        );
    }
