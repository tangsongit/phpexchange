...
class Option extends Bar
{
    ...
    public function handle(Request $request)
    {
        ...
        $default_coin = OptionBetCoin::query()
            ->where('is_bet', 1)
            ->orderBy('sort', 'desc')
            ->orderBy('coin_id', 'asc')
            ->value('coin_id');
...
<div class="d-flex p-1 flex-column justify-content-between" style="padding-top: 0;width: 100%;height: 100%;min-height: {$minHeight}">
    ...
    <a href="{$admin_url}/option/option-order?user_id={$user_id}" class="btn btn-primary shadow waves-effect waves-light">View Details <i class="feather icon-chevrons-right"></i></a>
</div>
HTML
        );
    }
