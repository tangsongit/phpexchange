...
class CreateInsideTradeDealRobotTable extends Migration
{
	...
	public function up()
	{
		Schema::create('inside_trade_deal_robot', function (Blueprint $table) {
	...
	{
		Schema::drop('inside_trade_deal_robot');
	}
}
