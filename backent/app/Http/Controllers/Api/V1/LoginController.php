...
class LoginController extends ApiController
{
    ...
    public function agent_register(Request $request)
    {
        ...
        $is_exist = \App\Models\Agent::query()->where(['username' => $account])->exists();
        ...
        try {
            ...
            if ($invite_code = $request->input('invite_code')) {
                ...
                // 代理条件限制
                if (
                    $params['subscribe_rebate_rate'] > $parent_user['subscribe_rebate_rate']
