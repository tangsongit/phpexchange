...
use App\Models\KjinCoinlist;
class KuangjCoinlistController extends AdminController
{
    /**
     * Make a grid builder.
     *
    ...
    {
        return Grid::make(new KjinCoinlist(), function (Grid $grid) {
    ...
    {
        return Show::make($id, new KjinCoinlist(), function (Show $show) {
            $show->field('id');
            $show->field('coin_id');
    ...
    {
        return Form::make(new KjinCoinlist(), function (Form $form) {
