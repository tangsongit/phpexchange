...
class KuangjAccountController extends AdminController
{
    ...
    {
        $query = KuangjiAccount::with(['user']);
    ...
    {
        return Show::make($id, new KuangjiAccount(), function (Show $show) {
            $show->field('id');
            $show->field('user_id');
            $show->field('coin_id');
    ...
    {
        return Form::make(new KuangjiAccount(), function (Form $form) {
            $form->display('id');
            $form->text('user_id');
            $form->text('coin_id');
            $form->text('coin_name');
