...
class Contract extends Bar
{
    ...
    public function handle(Request $request)
    {
        ...
        $builder1 = ContractEntrust::query()
            ...
            ->get(['fee', 'profit', 'created_at', 'settle_profit'])
            ->map(function ($v) {
                return [
                    'fee' => $v['fee'],
...
<div class="d-flex p-1 flex-column justify-content-between" style="padding-top: 0;width: 100%;height: 100%;min-height: {$minHeight}">
    ...
    <a href="{$admin_url}/contract-order?user_id={$user_id}" class="btn btn-primary shadow waves-effect waves-light">View Details <i class="feather icon-chevrons-right"></i></a>
</div>
HTML
        );
    }
